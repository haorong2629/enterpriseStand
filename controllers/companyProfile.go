...
//列表页
func (self *CompanyProfileController) List() {
	self.Data["pageTitle"] = "公司简介"
	self.display()
	// self.TplName = "aboutus/companyprofile/list.html"
}
//新增页
func (self *CompanyProfileController) Add() {
	self.Data["pageTitle"] = "公司简介新增"
	self.display()
}
//添加修改接口
func (self *CompanyProfileController) AjaxSave() {
	...
	if ArticleId == 0 {
		...
		// self.ajaxMsg("", MSG_OK)
		self.redirect(beego.URLFor("CompanyProfileController.List"))
	}
...
//列表接口
func (self *CompanyProfileController) Table() {
...
//查看详情 
func (self *CompanyProfileController) Detail() {
	// self.Data["ApiCss"] = true
	self.Data["pageTitle"] = "公司简介详情"
...
//编辑
func (self *CompanyProfileController) Edit() {
	self.Data["pageTitle"] = "公司简介编辑"
	id, _ := self.GetInt("id", 0)
	detail, _ := models.AboutUsGetById(id)
	row := make(map[string]interface{})
	row["id"] = detail.Id
...
//删除 接口
func (self *CompanyProfileController) AjaxDel() {	
	id, _ := self.GetInt("id")
